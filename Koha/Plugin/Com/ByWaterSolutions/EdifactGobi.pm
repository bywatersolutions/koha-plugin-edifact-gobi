package Koha::Plugin::Com::ByWaterSolutions::EdifactGobi;
...
our $metadata = {
    name            => 'Edifact - Gobi',
    author          => 'Kyle M Hall',
    description     => 'Edifact plugin for Gobi',
...
sub edifact {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactGobi::Edifact;

    my $edifact = Koha::Plugin::Com::ByWaterSolutions::EdifactGobi::Edifact->new($args);
    return $edifact;
}
...
sub edifact_order {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactGobi::Edifact::Order;

    $args->{params}->{plugin} = $self;
    my $edifact_order = Koha::Plugin::Com::ByWaterSolutions::EdifactGobi::Edifact::Order->new( $args->{params} );
...
sub edifact_transport {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactGobi::Edifact::Transport;

    $args->{params}->{plugin} = $self;

    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactGobi::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
