...
my $class = 'Koha::Plugin::Com::ByWaterSolutions::EdifactGobi::Edifact::Segment';
...
subtest 'de_escape removes EDIFACT release character' => sub {
    ...
    my $de_escape = \&Koha::Plugin::Com::ByWaterSolutions::EdifactGobi::Edifact::Segment::de_escape;
